...
namespace ProxyServer
{
    public partial class Form1 : Form
    {
        ...
        RemoteDBcon RmtDb = new RemoteDBcon("securecloud");
        ...
        void My_meter_SystemMeter_Event(object sender, Event_Meter e)
        {
           ...
           // setPieChart(pieChartControl1, Convert.ToDecimal(e.RamUsage), Convert.ToDecimal(100 - e.RamUsage));
           // setPieChart(pieChartControl3, Convert.ToDecimal(e.DiskUsage), Convert.ToDecimal(100 - e.DiskUsage));
           // label3.Text = Program.UserCount.ToString();
        }
        ...
        {
            My_meter.startMeter();
          uc=  listView3.Items.Count;
          if (!listBox1.Items.Contains(uc))
          {
        ...
        void TCPreceiver_MessageReceived(object sender, TcpMessageReceivedEventArgs e)
        {
            ...
            else if (e.Message.StartsWith("flag004"))
            {
               ...
               if (fc >= 500)
               {
                   listBox1.Items.Add(e.SourceIP);
               }
               label6.Text = fc.ToString();
        ...
        {
            TsSender ts = new TsSender(IPAddress.Parse("192.168.15.12"), 8000);
