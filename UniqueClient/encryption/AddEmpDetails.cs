            ...
            else
            {
                if (textBox2.Text == textBox3.Text)
                {
                    ...
                    else
                    {
                        ...
                        string stat = "0";
                        string s1 = "insert into emptb values(" + textBox9.Text + ",'" + Program.username + "','" + textBox1.Text + "','" + textBox2.Text + "','" + textBox4.Text + "','" + comboBox1.SelectedItem.ToString() + "','" + textBox11.Text + "','" + textBox7.Text + "','" + textBox8.Text + "','" + textBox5.Text + "','" + textBox6.Text + "'," + stat + ")";
                        con1.exec(s1);
