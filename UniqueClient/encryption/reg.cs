...
namespace encryption
{
    public partial class reg : Form
    {
        ...
        {
            if (textBox1.Text == "" || textBox5.Text == "" || textBox2.Text == "" || textBox9.Text == "" || textBox3.Text == "" || textBox4.Text == "" || textBox5.Text == "" || textBox8.Text == "" || textBox7.Text == "" || textBox11.Text == ""|| comboBox2.Text=="")
            {
                ...
                if (regValidations() == true)
                {
                    ...
                    else
                    {
                        if (textBox2.Text == textBox3.Text)
                        {
                            ...
                            string s = "insert into reg values(" + textBox9.Text + ",'" + textBox4.Text + "','" + gen + "','" + textBox7.Text + "','" + textBox11.Text + "','" + textBox5.Text + "','" + textBox10.Text + "','" + textBox8.Text + "','" + textBox1.Text + "','" + textBox2.Text + "'," + stat + ",'"+comboBox2.SelectedItem.ToString()+"','"+textBox6.Text+"','"+textBox14.Text+"','"+textBox13.Text+"')";
        ...
        private void reg_Load(object sender, EventArgs e)
        {
            ...
            comboBox2.Items.Add("L1U10G");
            comboBox2.Items.Add("L1U50G");
            comboBox2.Items.Add("L1U100G");
            comboBox2.Items.Add("L1U500G");
     ...
     + @"([a-zA-Z]+[\w-]+\.)+[a-zA-Z]{2,4})$");
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            comboBox2.Items.Add("L1U100G");
            comboBox2.Items.Add("L1U500G");
            if (comboBox2.SelectedItem.ToString() == "L1U10G")
            {
                textBox6.Text = "10GB";
                textBox12.Text = "1 Month";
                textBox14.Text="Rs:5000";
              
            }
            if (comboBox2.SelectedItem.ToString() == "L1U50G")
            {
                textBox6.Text = "50GB";
                textBox12.Text = "1 Month";
                textBox14.Text = "Rs:8000";

            }
            if (comboBox2.SelectedItem.ToString() == "L1U100G")
            {
                textBox6.Text = "100GB";
                textBox12.Text = "1 Month";
                textBox14.Text = "Rs:12000";

            }
            if (comboBox2.SelectedItem.ToString() == "L1U500G")
            {
                textBox6.Text = "500GB";
                textBox12.Text = "1 Month";
                textBox14.Text = "Rs:20000";
